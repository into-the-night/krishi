...
class Bot:
    ...
    def analyse_output(self, diagnosis_result, image: Image, language: str = "en"):
        ...
        You need to examine the result and provide a detailed analysis of the plant disease and/or pest to a farmer in a friendly and easy to understand manner.
    ...
    def chat(self, history: list, language: str = "en"):
        ...
        You are to provide a response to the farmer in a friendly and easy to understand manner.
